...
void main()
{
	...
	Node* common_ancestor = findLowestCommonAncestor(newnode, newnode3, newnode4);
	printf("Lowest common ancestor of 4 and 11 is %d (should be 5)\n", common_ancestor->data);
	...
	common_ancestor = findLowestCommonAncestor(newnode, newnode4, newnode5);
	printf("Lowest common ancestor of 11 and 6 is %d (should be 6)\n", common_ancestor->data);
